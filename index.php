...
<form class="form-inline ml-auto" action="action.php" method="POST">
    <input class="form-control mr-sm-2" type="text" name="get_id" placeholder="What are you looking for?" style="height:40px;width:1001px">
    <button class="btn btn-info " name="search_by_id"type="submit">Search</button>
  </form>
</div>

<div class="container py-5">
        <h2 class="text-center">Popular Products</h2><br>
<hr><br><br>
